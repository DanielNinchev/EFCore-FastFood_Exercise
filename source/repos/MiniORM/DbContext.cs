...
namespace MiniORM
{
	public abstract class DbContext
    {
        ...
        private static bool IsObjectValid(object entity)
        {
            ...
            bool validationResult = Validator.TryValidateObject(entity, validationContext, validationErrors);
        ...
        private void PersistDbSet<TEntity>(PropertyInfo dbSet) where TEntity : class, new()
        {
